export default class ColumnProperties{
	...
	Show(){
		...
		widget.append(`<div class="title-line"><label>general</label></div>`);
		widget.append(this.#set_name());
		widget.append(this.#set_datatype());
		widget.append(this.#set_comment());
		widget.append(`<div class="title-line"><label>data editor</label></div>`);
		...
		widget.append(`<div class="title-line"><label>database</label></div>`);
		...
		widget.append(`<div class="title-line"><label>foreign key</label></div>`);
		widget.append(this.#hide_connector());
		this.#set_foreign_key(widget);

		// _init_foreign_keys(widget, obj);
