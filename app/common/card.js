...
function Card(content, on_show, on_close){
    ...
    if (typeof on_show === 'function' || 
		...
		options = Object.assign(options, on_show);
	}
	...
	var div = $(`<div class="popup-card">
					<div class="header-row">
						<div class="drag-me header title"/>
						<div class="">
							<i class="close-btn las la-fw la-lg la-times" />
						</div>
					</div>
