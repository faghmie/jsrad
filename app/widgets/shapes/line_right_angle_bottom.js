...
export default class LineRightAngleBottom extends BaseShape {
	create_shape() {
		...
		ctx.lineTo(border_width, canvas.height - border_width - size);
		ctx.lineTo(canvas.width - border_width, canvas.height - border_width - size);
		ctx.lineTo(canvas.width - border_width - size, canvas.height - border_width);
		ctx.lineTo(canvas.width - border_width, canvas.height - border_width - size);
		ctx.lineTo(canvas.width - border_width - size, canvas.height - border_width - 2 * size);
