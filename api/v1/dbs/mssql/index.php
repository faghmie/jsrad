<?php
	...
	function create($obj){
		...
		exit_with_response(null, null, $sql_result);
	}
	...
	function update($obj){
		...
		exit_with_response(null, null, $rst);
	}
	...
	function get_mssql_for_object($obj, $single_record=false, $specific_group=true){
		$sql = '';
		$sql_single = '';
		$alias_list = array();
		//print_r($obj);
